...
function Experience() {
  ...
  const items = [
  { year: '2024 — Now', role: 'Marketing Manager', org: 'Orange County United Way', desc: 'Own strategy and execution for the organization\u2019s largest fundraising and engagement programs, managing campaign strategy, an internal creative team, and agency partnerships across multiple initiatives.', pills: ['Campaign strategy', 'Creative team', 'Agency partnerships', 'Fundraising programs'] },
  { year: '2022 — 2023', role: 'Account Development Representative', org: 'Stardog', desc: 'B2B SaaS sales role at an enterprise data and AI platform, building outbound pipeline and translating AI, semantic search, and enterprise data concepts into messaging for technical and non-technical buyers.', pills: ['Positioning', 'B2B', 'Enterprise', 'SQL'] },
  ...
  { year: '2019 — 2020', role: 'Marketing Lead', org: 'Tustin Chamber of Commerce', desc: 'Led all marketing operations across digital content, social media, and promotional campaigns, driving 715% audience growth through original content, engagement strategies, and paid ads.', pills: ['Social', 'Content', 'Community'] },
