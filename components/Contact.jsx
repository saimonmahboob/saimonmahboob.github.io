    ...
    <section id="contact" ref={sectionRef} style={contactStyles.wrap}>
      ...
      <style>{`
        @keyframes verb-in {
          ...
          55%  { opacity: 1; }
          100% { transform: translateY(0);      clip-path: inset(-0.2em -0.3em -0.25em -0.05em); opacity: 1; }
        }
        @keyframes verb-out {
          0%   { transform: translateY(0);       clip-path: inset(-0.2em -0.3em -0.25em -0.05em); opacity: 1; }
